...
import { GetCase, AllPersonGQL, GetCaseGQL, RenamedcaseWhereInput, GetConsultationGQL, GetPk, GetPkGQL, PersonOrderByInput, SortOrder, RenamedcaseOrderByInput } from '@shared';

import { STComponent, STColumn, STData, STChange, STColumnSort, STPage } from '@delon/abc/st';
...
export class CasesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.casesObs = this.cases.valueChanges
      ...
      .subscribe(async res => {
        ...
        this.data = await this.translateMtVocab(res.renamedcases);
        this.st.total = res.aggregateRenamedcase.count.id;
        this.cdr.detectChanges();
      });
  }

  async translateMtVocab(cases) {
  ...
  getData() {
    ...
    this.cases
      ...
      .then(async res => {
        this.data = await this.translateMtVocab(res.data.renamedcases);
