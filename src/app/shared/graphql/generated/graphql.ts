...
export type DestroyRolesMutationVariables = Exact<{
...
export type DestroyLogMutationVariables = Exact<{
...
export type DestroyLitMutationVariables = Exact<{
...
export type DestroyNonlitMutationVariables = Exact<{
...
export type DestroyKorbanMutationVariables = Exact<{
...
export type DestroyPelakuMutationVariables = Exact<{
...
export type DestroyCaseViolatedRightMutationVariables = Exact<{
...
export type DestroyCaseClassificationMutationVariables = Exact<{
...
export type DestroyCaseProgressActivityMutationVariables = Exact<{
...
export type DestroyCaseIssueMutationVariables = Exact<{
...
export type PostLogRequestMutation = { createLogRequest: (
    Pick<LogRequest, 'ID' | 'isiRequest' | 'jenisRequest' | 'tanggapanRequest' | 'tanggapanRequestIsi' | 'tglExpired' | 'tglRequest' | 'tglRespon'>
    & { caseId?: Maybe<Pick<Renamedcase, 'id'>>, applicationId?: Maybe<Pick<Application, 'id' | 'tahap'>>, networkId?: Maybe<Pick<Network, 'id'>>, personId?: Maybe<Pick<Person, 'id'>>, pp: Array<Pick<LogRequestApp, 'id'>>, requestBy?: Maybe<Pick<User, 'id'>>, requestTo?: Maybe<Pick<User, 'id'>> }
  ) };
...
export type PostUserMutation = { createUser: (
    Pick<User, 'address' | 'avatar' | 'createdAt' | 'deletedAt' | 'email' | 'id' | 'name' | 'password' | 'phone' | 'position' | 'rememberToken' | 'roles' | 'status' | 'updatedAt' | 'username'>
    & { profile?: Maybe<Pick<UserProfile, 'id' | 'noContact'>> }
  ) };

export type PostNetworkMutationVariables = Exact<{
  data: NetworkCreateInput;
}>;
...
export type PostClientMutationVariables = Exact<{
  data: ClientCreateInput;
}>;


export type PostClientMutation = { createClient: (
    ...
    & { applicationId?: Maybe<Pick<Application, 'id'>>, personId?: Maybe<Pick<Person, 'id'>> }
  ) };

export type PostApplicationMutationVariables = Exact<{
  data: ApplicationCreateInput;
}>;


export type PostApplicationMutation = { createApplication: (
    ...
    & { wakilId?: Maybe<Pick<Person, 'id' | 'namaLengkap'>>, case?: Maybe<Pick<Renamedcase, 'id'>>, clients: Array<(
      Pick<Client, 'id' | 'alamatLokasi' | 'asetGedung' | 'asetKios' | 'asetLahanGarapan' | 'asetLapak' | 'asetMobil' | 'asetMotor' | 'asetRumah' | 'asetTanah' | 'asetToko' | 'asetWarung' | 'createdAt' | 'createdBy' | 'pendapatan' | 'sktm' | 'sktmUpload' | 'stmKeterangan' | 'tanggunganAnak' | 'tanggunganFamili' | 'tanggunganLain' | 'tanggunganPasangan' | 'updatedAt' | 'updatedBy' | 'usiaSaatKlien'>
      & { personId?: Maybe<Pick<Person, 'id' | 'namaLengkap'>> }
    )> }
  ) };
...
export type PutCaseMutation = { updateRenamedcase?: Maybe<(
    ...
    )>, documents: Array<Pick<CaseDocument, 'jenisDokumen' | 'judulDokumen' | 'keterangan' | 'filename' | 'link'>>, issues: Array<Pick<CaseIssue, 'id' | 'kodeMt'>>, korbans: Array<(
      Pick<CaseKorban, 'id'>
      & { personId?: Maybe<Pick<Person, 'namaLengkap' | 'id'>> }
    )>, pelakus: Array<(
      Pick<CasePelaku, 'id' | 'jenisPelaku'>
      & { personId?: Maybe<Pick<Person, 'namaLengkap' | 'id'>> }
    )>, pk?: Maybe<(
      Pick<CasePk, 'id' | 'createdAt' | 'createdBy' | 'didampingi' | 'legalMemo' | 'notulaRapat' | 'strategiAdvokasi' | 'targetAkhirAdvokasi' | 'statusAlasanTdk' | 'tglRapat'>
      & { ppPendamping?: Maybe<(
        Pick<User, 'address' | 'avatar' | 'createdAt' | 'deletedAt' | 'email' | 'id' | 'name' | 'password' | 'phone' | 'position' | 'rememberToken' | 'roles' | 'status' | 'updatedAt' | 'username'>
        & { profile?: Maybe<Pick<UserProfile, 'id' | 'noContact'>> }
      )> }
    )>, progresses?: Maybe<Pick<CaseProgress, 'id' | 'catatan' | 'jenisPeradilan'>>, activities: Array<(
      Pick<CaseProgressActivity, 'id' | 'capaian' | 'hambatan' | 'judulAktifitas' | 'position' | 'rencanaStrategi' | 'targetAdvokasi'>
    ...
    )>, transferreferrals: Array<Pick<CaseTransferReferral, 'id' | 'catatan' | 'document' | 'jenisTransferReferral' | 'networkId' | 'updatedAt' | 'updatedBy'>>, violatedrights: Array<Pick<CaseViolatedRight, 'id' | 'kodeMt'>> }
  )> };

export type PutLogRequestMutationVariables = Exact<{
  data: LogRequestUpdateInput;
  where: LogRequestWhereUniqueInput;
}>;


export type PutLogRequestMutation = { updateLogRequest?: Maybe<(
    Pick<LogRequest, 'ID' | 'isiRequest' | 'jenisRequest' | 'tanggapanRequest' | 'tanggapanRequestIsi' | 'tglExpired' | 'tglRequest' | 'tglRespon'>
    & { caseId?: Maybe<Pick<Renamedcase, 'id'>>, applicationId?: Maybe<Pick<Application, 'id'>>, networkId?: Maybe<Pick<Network, 'id'>>, personId?: Maybe<Pick<Person, 'id'>>, pp: Array<Pick<LogRequestApp, 'id'>>, requestBy?: Maybe<Pick<User, 'id'>>, requestTo?: Maybe<Pick<User, 'id'>> }
  )> };
...
export type PutUserMutation = { updateUser?: Maybe<(
    Pick<User, 'address' | 'avatar' | 'createdAt' | 'deletedAt' | 'email' | 'id' | 'name' | 'password' | 'phone' | 'position' | 'rememberToken' | 'roles' | 'status' | 'updatedAt' | 'username'>
    & { profile?: Maybe<Pick<UserProfile, 'id' | 'noContact'>> }
  )> };

export type PutNetworkMutationVariables = Exact<{
  data: NetworkUpdateInput;
  where: NetworkWhereUniqueInput;
}>;
...
export type PutApplicationMutationVariables = Exact<{
  data: ApplicationUpdateInput;
  where: ApplicationWhereUniqueInput;
}>;


export type PutApplicationMutation = { updateApplication?: Maybe<(
    Pick<Application, 'id' | 'createdAt' | 'createdBy' | 'dudukPerara' | 'infoLbh' | 'jumlahPenerimaManfaat' | 'konfirmasiData' | 'noReg' | 'pernahKlien' | 'pernahPpLain' | 'ppLain' | 'regDate' | 'relasiWakilClient' | 'setujuAdvokasi' | 'statusPerwakilan' | 'updatedAt' | 'updatedBy' | 'waktuPernahKlien' | 'whyLbh'>
    & { wakilId?: Maybe<Pick<Person, 'id' | 'namaLengkap'>>, case?: Maybe<Pick<Renamedcase, 'id'>>, clients: Array<(
      Pick<Client, 'id' | 'alamatLokasi' | 'asetGedung' | 'asetKios' | 'asetLahanGarapan' | 'asetLapak' | 'asetMobil' | 'asetMotor' | 'asetRumah' | 'asetTanah' | 'asetToko' | 'asetWarung' | 'createdAt' | 'createdBy' | 'pendapatan' | 'sktm' | 'sktmUpload' | 'stmKeterangan' | 'tanggunganAnak' | 'tanggunganFamili' | 'tanggunganLain' | 'tanggunganPasangan' | 'updatedAt' | 'updatedBy' | 'usiaSaatKlien'>
      & { personId?: Maybe<Pick<Person, 'id' | 'namaLengkap'>> }
...
export type PostPersonMutationVariables = Exact<{
  data: PersonCreateInput;
}>;
...
export type GetLogRequestQueryVariables = Exact<{
  where?: Maybe<LogRequestWhereInput>;
  orderBy?: Maybe<Array<LogRequestOrderByInput> | LogRequestOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;


export type GetLogRequestQuery = { logRequests: Array<(
    Pick<LogRequest, 'ID' | 'updatedAt' | 'isiRequest' | 'tanggapanRequestIsi' | 'jenisRequest' | 'statusRequest' | 'tanggapanRequest' | 'tglExpired' | 'tglRequest' | 'tglRespon'>
    & { caseId?: Maybe<(
      Pick<Renamedcase, 'id' | 'judulKasus' | 'kronologiKasus'>
      & { transfer?: Maybe<(
        Pick<CaseTransfer, 'id' | 'tglTransfer'>
        & { network?: Maybe<Pick<Network, 'id' | 'name'>> }
      )>, application?: Maybe<(
        Pick<Application, 'id' | 'noReg'>
        & { clients: Array<(
          Pick<Client, 'id'>
          & { personId?: Maybe<Pick<Person, 'id' | 'namaLengkap'>> }
        )> }
      )>, pk?: Maybe<Pick<CasePk, 'id' | 'didampingi' | 'tglRapat'>> }
    )>, applicationId?: Maybe<(
    ...
    )>, networkId?: Maybe<Pick<Network, 'id' | 'name'>>, personId?: Maybe<Pick<Person, 'id' | 'namaLengkap'>>, pp: Array<(
      Pick<LogRequestApp, 'id'>
      & { appConsultation?: Maybe<Pick<User, 'name' | 'id'>> }
    )>, requestBy?: Maybe<Pick<User, 'id' | 'name'>>, requestTo?: Maybe<Pick<User, 'id'>> }
  )>, aggregateLogRequest: { count?: Maybe<Pick<LogRequestCountAggregate, 'ID'>> } };

export type GetRolesTypeQueryVariables = Exact<{
  where?: Maybe<RolesTypeWhereInput>;
  orderBy?: Maybe<Array<RolesTypeOrderByInput> | RolesTypeOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;
...
export type GetNetworksQueryVariables = Exact<{
  where?: Maybe<NetworkWhereInput>;
  orderBy?: Maybe<Array<NetworkOrderByInput> | NetworkOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;


export type GetNetworksQuery = { networks: Array<Pick<Network, 'address' | 'contactPerson' | 'createdAt' | 'email' | 'id' | 'name' | 'noContact' | 'provinceId' | 'regencyId' | 'type' | 'status' | 'updatedAt'>>, aggregateNetwork: { count?: Maybe<Pick<NetworkCountAggregate, 'id'>> } };
...
export type GetUserQuery = { users: Array<(
    Pick<User, 'address' | 'avatar' | 'createdAt' | 'deletedAt' | 'email' | 'id' | 'name' | 'password' | 'phone' | 'position' | 'rememberToken' | 'roles' | 'status' | 'updatedAt' | 'username'>
    & { profile?: Maybe<Pick<UserProfile, 'id' | 'noContact'>>, roles_type: Array<(
      Pick<Role, 'id'>
      & { type?: Maybe<Pick<RolesType, 'id' | 'description'>> }
    )> }
  )>, aggregateUser: { count?: Maybe<Pick<UserCountAggregate, 'id'>> } };

export type GetCaseQueryVariables = Exact<{
  where?: Maybe<RenamedcaseWhereInput>;
  orderBy?: Maybe<Array<RenamedcaseOrderByInput> | RenamedcaseOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;
...
export type GetCaseQuery = { renamedcases: Array<(
    ...
    & { transfer?: Maybe<(
      ...
      Pick<CaseReferral, 'id' | 'tglTransfer' | 'catatan' | 'createdBy' | 'updatedBy'>
      ...
      & { caseId?: Maybe<(
        Pick<Renamedcase, 'id'>
        & { application?: Maybe<Pick<Application, 'id' | 'noReg'>> }
      )>, apps: Array<(
        Pick<CaseConsultationApp, 'id'>
        & { appConsultation?: Maybe<(
          Pick<User, 'name' | 'id'>
          & { roles_type: Array<(
            Pick<Role, 'id'>
            & { type?: Maybe<Pick<RolesType, 'id'>> }
          )> }
        )> }
      )> }
    )>, documents: Array<Pick<CaseDocument, 'id' | 'jenisDokumen' | 'judulDokumen' | 'keterangan' | 'filename' | 'link' | 'createdAt'>>, issues: Array<Pick<CaseIssue, 'id' | 'kodeMt'>>, korbans: Array<(
      Pick<CaseKorban, 'id'>
      & { personId?: Maybe<Pick<Person, 'namaLengkap' | 'id'>> }
    )>, pelakus: Array<(
      Pick<CasePelaku, 'id' | 'jenisPelaku'>
      ...
      )>, networkId?: Maybe<Pick<Network, 'id'>>, personId?: Maybe<Pick<Person, 'id'>>, pp: Array<(
        Pick<LogRequestApp, 'id'>
        & { appConsultation?: Maybe<(
          Pick<User, 'name' | 'id'>
          & { roles_type: Array<(
      ...
      )>, requestBy?: Maybe<Pick<User, 'id'>>, requestTo?: Maybe<Pick<User, 'id'>> }
    )> }
  )>, aggregateRenamedcase: { count?: Maybe<Pick<RenamedcaseCountAggregate, 'id'>> } };

export type GetConsultationQueryVariables = Exact<{
  where?: Maybe<CaseConsultationWhereInput>;
  orderBy?: Maybe<Array<CaseConsultationOrderByInput> | CaseConsultationOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;
...
export type GetPkQueryVariables = Exact<{
  where?: Maybe<CasePkWhereInput>;
  orderBy?: Maybe<Array<CasePkOrderByInput> | CasePkOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;
...
export type GetClientQuery = { clients: Array<(
    Pick<Client, 'id' | 'alamatLokasi' | 'asetGedung' | 'asetKios' | 'asetLahanGarapan' | 'asetLapak' | 'asetMobil' | 'asetMotor' | 'asetRumah' | 'asetTanah' | 'asetToko' | 'asetWarung' | 'createdAt' | 'createdBy' | 'pendapatan' | 'sktm' | 'sktmUpload' | 'stmKeterangan' | 'tanggunganAnak' | 'tanggunganFamili' | 'tanggunganLain' | 'tanggunganPasangan' | 'updatedAt' | 'updatedBy' | 'usiaSaatKlien'>
    & { applicationId?: Maybe<Pick<Application, 'id'>>, personId?: Maybe<Pick<Person, 'id'>> }
  )> };
...
export type GetApplicationsQueryVariables = Exact<{
  where?: Maybe<ApplicationWhereInput>;
  orderBy?: Maybe<Array<ApplicationOrderByInput> | ApplicationOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;


export type GetApplicationsQuery = { applications: Array<(
    Pick<Application, 'id' | 'createdAt' | 'createdBy' | 'dudukPerara' | 'infoLbh' | 'jumlahPenerimaManfaat' | 'konfirmasiData' | 'noReg' | 'pernahKlien' | 'pernahPpLain' | 'ppLain' | 'regDate' | 'relasiWakilClient' | 'setujuAdvokasi' | 'statusPerwakilan' | 'updatedAt' | 'updatedBy' | 'waktuPernahKlien' | 'whyLbh'>
...
export type GetMtVocabsQueryVariables = Exact<{
  where?: Maybe<MtVocabWhereInput>;
  orderBy?: Maybe<Array<MtVocabOrderByInput> | MtVocabOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;
...
export type AllPersonQueryVariables = Exact<{
  where?: Maybe<PersonWhereInput>;
  orderBy?: Maybe<Array<PersonOrderByInput> | PersonOrderByInput>;
  skip?: Maybe<Scalars['Int']>;
  take?: Maybe<Scalars['Int']>;
}>;
...
export type GetDashboardDataQueryVariables = Exact<{
  ...
  whereViolatedRights?: Maybe<CaseViolatedRightWhereInput>;
  whereViolenceMethods?: Maybe<CaseViolenceMethodWhereInput>;
  whereCaseModuses?: Maybe<CaseModusWhereInput>;
  whereOrientasiSeksual?: Maybe<RenamedcaseWhereInput>;
  whereCaseCategory?: Maybe<CaseCategoryWhereInput>;
}>;


export type GetDashboardDataQuery = { renamedcases: Array<{ application?: Maybe<{ clients: Array<{ personId?: Maybe<Pick<Person, 'orientasiSeksual'>> }> }> }>, caseCategories: Array<Pick<CaseCategory, 'id' | 'kodeMt' | 'case_id'>>, caseModuses: Array<Pick<CaseModus, 'id' | 'kodeMt' | 'case_id'>>, caseViolatedRights: Array<Pick<CaseViolatedRight, 'id' | 'kodeMt' | 'case_id'>>, caseViolenceMethods: Array<Pick<CaseViolenceMethod, 'id' | 'kodeMt' | 'case_id'>>, aggregateApplication: { count?: Maybe<Pick<ApplicationCountAggregate, 'id'>>, sum?: Maybe<Pick<ApplicationSumAggregate, 'jumlahPenerimaManfaat'>> }, aggregateCaseTransfer: { count?: Maybe<Pick<CaseTransferCountAggregate, 'id'>> }, aggregateCaseReferral: { count?: Maybe<Pick<CaseReferralCountAggregate, 'id'>> }, aggregateCase: { count?: Maybe<Pick<RenamedcaseCountAggregate, 'id'>> }, aggregateCaseConsultation: { count?: Maybe<Pick<CaseConsultationCountAggregate, 'id'>> }, aggregateActiveCase: { count?: Maybe<Pick<RenamedcaseCountAggregate, 'id'>> }, aggregateFinishedCase: { count?: Maybe<Pick<RenamedcaseCountAggregate, 'id'>> } };
...
export const GetLogRequestDocument = gql`
  ...
  aggregateLogRequest(where: $where) {
    count {
      ID
    }
  }
...
export const GetCaseDocument = gql`
  ...
  aggregateRenamedcase(where: $where) {
    count {
      id
    }
  }
...
export const GetApplicationsDocument = gql`
  ...
  aggregateApplication(where: $where) {
    count {
      id
    }
  }
...
export const GetDashboardDataDocument = gql`
    query getDashboardData($whereAggApplication: ApplicationWhereInput, $whereAggTransfer: CaseTransferWhereInput, $whereAggRujukan: CaseReferralWhereInput, $whereAggCase: RenamedcaseWhereInput, $whereAggConsultation: CaseConsultationWhereInput, $whereAggActiveCase: RenamedcaseWhereInput, $whereAggFinishedCase: RenamedcaseWhereInput, $whereViolatedRights: CaseViolatedRightWhereInput, $whereViolenceMethods: CaseViolenceMethodWhereInput, $whereCaseModuses: CaseModusWhereInput, $whereOrientasiSeksual: RenamedcaseWhereInput, $whereCaseCategory: CaseCategoryWhereInput) {
  renamedcases(where: $whereOrientasiSeksual) {
    application {
      clients {
        personId {
          orientasiSeksual
  ...
  caseCategories(where: $whereCaseCategory) {
    id
    kodeMt
    case_id
  }
  caseModuses(where: $whereCaseModuses) {
    id
    kodeMt
    case_id
  }
  caseViolatedRights(where: $whereViolatedRights) {
    id
    kodeMt
    case_id
  }
  caseViolenceMethods(where: $whereViolenceMethods) {
    id
    kodeMt
    case_id
  }
...
export namespace GetLogRequest {
  ...
  export type AggregateLogRequest = GetLogRequestQuery['aggregateLogRequest'];
  export type Count = GetLogRequestQuery['aggregateLogRequest']['count'];
}
...
export namespace GetNetworks {
  ...
  export type AggregateNetwork = GetNetworksQuery['aggregateNetwork'];
  export type Count = GetNetworksQuery['aggregateNetwork']['count'];
}
...
export namespace GetUser {
  ...
  export type AggregateUser = GetUserQuery['aggregateUser'];
  export type Count = GetUserQuery['aggregateUser']['count'];
}
...
export namespace GetCase {
  ...
  export type AggregateRenamedcase = GetCaseQuery['aggregateRenamedcase'];
  export type Count = GetCaseQuery['aggregateRenamedcase']['count'];
}
...
export namespace GetApplications {
  ...
  export type AggregateApplication = GetApplicationsQuery['aggregateApplication'];
  export type Count = GetApplicationsQuery['aggregateApplication']['count'];
}
...
export namespace GetDashboardData {
  ...
  export type Renamedcases = GetDashboardDataQuery['renamedcases'][0];
  export type Application = GetDashboardDataQuery['renamedcases'][0]['application'];
  export type Clients = GetDashboardDataQuery['renamedcases'][0]['application']['clients'][0];
  export type PersonId = GetDashboardDataQuery['renamedcases'][0]['application']['clients'][0]['personId'];
  export type CaseCategories = GetDashboardDataQuery['caseCategories'][0];
  export type CaseModuses = GetDashboardDataQuery['caseModuses'][0];
  export type CaseViolatedRights = GetDashboardDataQuery['caseViolatedRights'][0];
  export type CaseViolenceMethods = GetDashboardDataQuery['caseViolenceMethods'][0];
